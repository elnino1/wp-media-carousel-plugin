 ...
 *
 * Stores like counts in post meta (_inkiz_mc_likes).
 * Uses AJAX for logged-in and anonymous visitors.
 */
class Likes {

    private const META_KEY = '_inkiz_mc_likes';

    public function register(): void {
        add_action( 'wp_ajax_inkiz_mc_like',        [ $this, 'handle_like' ] );
        add_action( 'wp_ajax_nopriv_inkiz_mc_like', [ $this, 'handle_like' ] );
    }
    ...
    public function handle_like(): void {
        check_ajax_referer( 'inkiz_mc_nonce', 'nonce' );
